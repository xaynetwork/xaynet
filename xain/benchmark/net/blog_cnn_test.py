...
def test_seed_mnist():
    ...
    # Execute
    model_a = blog_cnn_compiled(input_shape=(28, 28, 1), num_classes=10, seed=SEED)
    model_b = blog_cnn_compiled(input_shape=(28, 28, 1), num_classes=10, seed=SEED)
...
def test_seed_cifar():
    ...
    # Execute
    model_a = blog_cnn_compiled(input_shape=(32, 32, 3), num_classes=10, seed=SEED)
    model_b = blog_cnn_compiled(input_shape=(32, 32, 3), num_classes=10, seed=SEED)
...
def test_seed_unequal():
    ...
    # Execute
    model_a = blog_cnn_compiled(input_shape=(28, 28, 1), num_classes=10, seed=3)
    model_b = blog_cnn_compiled(input_shape=(28, 28, 1), num_classes=10, seed=4)
