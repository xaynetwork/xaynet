...
class ParticipantMessage(google___protobuf___message___Message):
    ...
    class TrainResult(google___protobuf___message___Message):
        ...
        @classmethod
        def FromString(cls, s: bytes) -> ParticipantMessage.TrainResult: ...
    ...
    @property
    def result(self) -> ParticipantMessage.TrainResult: ...

    def __init__(self,
        *,
        result : typing___Optional[ParticipantMessage.TrainResult] = None,
