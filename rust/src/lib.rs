...
//! Rust has definitely potential as a host language for machine learning itself. But, above, we
...
//! - **Compiles and runs “everywhere”** The language should *not* require its own runtime and
//!   code should compile on a wide range of devices.
//! - **Memory and Concurreny Safety**] Code that compiles should be both memory safe and free of
//!   data races.
