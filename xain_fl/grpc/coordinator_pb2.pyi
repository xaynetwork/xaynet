...
class EndTrainingRequest(google___protobuf___message___Message):
    ...
    class WeightUpdate(google___protobuf___message___Message):
        ...
        @classmethod
        def FromString(cls, s: bytes) -> EndTrainingRequest.WeightUpdate: ...
        def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        if sys.version_info >= (3,):
    ...
    @property
    def weight_update(self) -> EndTrainingRequest.WeightUpdate: ...
    ...
    def __init__(self,
        *,
        weight_update : typing___Optional[EndTrainingRequest.WeightUpdate] = None,
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"weight_update"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"metrics",u"weight_update"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"weight_update",b"weight_update"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"metrics",b"metrics",u"weight_update",b"weight_update"]) -> None: ...
