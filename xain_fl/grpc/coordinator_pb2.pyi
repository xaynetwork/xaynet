...
class EndTrainingRequest(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    class MetricEntry(google___protobuf___message___Message):
        DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
        ...
        @classmethod
        def FromString(cls, s: bytes) -> EndTrainingRequest.MetricEntry: ...
        def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        if sys.version_info >= (3,):
    ...
    @property
    def metric(self) -> typing___MutableMapping[typing___Text, EndTrainingRequest.Metrics]: ...

    def __init__(self,
        *,
        theta_update : typing___Optional[EndTrainingRequest.ThetaUpdate] = None,
        metric : typing___Optional[typing___Mapping[typing___Text, EndTrainingRequest.Metrics]] = None,
        ) -> None: ...
    @classmethod
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"theta_update"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"metric",u"theta_update"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"theta_update",b"theta_update"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"metric",b"metric",u"theta_update",b"theta_update"]) -> None: ...
