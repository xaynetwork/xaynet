...
class EndTrainingRequest(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"metrics",u"theta_update"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"theta_update",b"theta_update"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"metrics",b"metrics",u"theta_update",b"theta_update"]) -> None: ...
